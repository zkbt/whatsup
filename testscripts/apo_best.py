...
p = plan.Plan(observatory='APO', semester='Bally',  start='2016-11-20', finish='2016-12-25', maxairmass=2.5, maxsun=-6.0)
p.known = Confirmed()
...
#p.printTransits()
p.plotTransits()
p.movie(filename='apo_novemberdecember_within300.mp4')
